...
<body>
    ...
    if($_POST['upload']){
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            if($ukuran < 1044070){ 
                ...
                $cek= mysqli_query($koneksi,"INSERT INTO tb_bukuedukasi (judulbuku,buku,cover) VALUES('$judulbuku', '$nama','$cover')");
        ...
        header("Location: formbukuedukasi.php");
    }
    ?> 
    <br/>
    <br/>
    ...
    <table>
        <?php 
            $data = mysqli_query($koneksi,"SELECT * FROM tb_bukuedukasi");
