                    ...
                    <div class="projects-holder">
                        <div class="row">
                            <div class="col-md-3 col-sm-6 project-item mix nature">
                              <div class="image">
                                <a href="icon/book1.png" data-lightbox="image-1"><img src="icon/book1.png"></a>
                              </div>
                              <div class="text">
                                 <div class ="primary-button"><center><a href="">IPA</a></button></center></div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix webdesign">
                              ...
                              <div class="text">
                              <div class ="primary-button"><center><a href="">IPS</a></button></center></div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix responsive">
                              ...
                              <div class="text">
                              <div class ="primary-button"><center><a href="">BAHASA</a></button></center></div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix creative nature">
                              ...
                              <div class="text">
                              <div class ="primary-button"><center><a href="">BAHASA INGGRIS</a></button></center></div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix creative nature">
                              <div class="image">
                              ...
                              <div class="text">
                              <div class ="primary-button"><center><a href="">SENI</a></button></center></div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix creative nature">
                              <div class="image">
